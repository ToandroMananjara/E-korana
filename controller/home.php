...
class Home
{
    ...
    public function index()
    {
        ...
        if (isset($_SESSION['email'])) {
            ...
            $datas = [];
            $datas['user_current'] = $myUser; // Stocke les informations de l'utilisateur courant

            $datas['posts'] = []; // Initialise un tableau pour les publications
            ...
            foreach ($posts as $post) {
                ...
                if (sizeof($comments) != 0) {
                    ...
                    $datas['posts'][] = [ // Utilise [] pour ajouter au tableau des publications
                        'post_id' => $post['id'],
