<div class="post mt-2 p-2 p-sm-4  position-relative" data-id="<?= $data['post_id'] ?>">
    <!-- <input type="hidden" id="id_comment" name="id_post" value="<?= $data['post']['id'] ?>"> -->

    <div class="more-post position-absolute" onclick="handleMorePost(this)">
        ...
    </div>
        ...
        <div class="contenu">
            ...
            <div class="action">
                ...
                <div class="d-flex p-4 pt-0 pb-0">
                    ...
                    <div class="chat-comment col-6 d-flex justify-content-end align-items-center gap-2">
